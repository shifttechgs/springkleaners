    ...
    <div class="section-wrap py-16">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="tel:+27814303023" class="flex items-center gap-2 text-white/60 hover:text-[#f6e304] text-[14px] transition-colors">
                    ...
                    <li>
                        <a href="https://wa.me/27814303023" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-white/60 hover:text-green-400 text-[14px] transition-colors">
