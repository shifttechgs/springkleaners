...
@section('content')
    ...
    <div class="flex items-center gap-2 text-label text-[12px] font-medium mb-6">
        ...
        <span>/</span>
        <span class="text-ink">Add Service</span>
    </div>
        ...
        <form method="POST" action="{{ route('admin.services.store') }}" class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" name="service_fee" value="{{ old('service_fee', 0) }}" required
                           class="w-full bg-white border border-line rounded-xl px-3.5 py-2.5 text-[13px] text-ink focus:border-navy focus:outline-none transition-colors">
                </div>
                <div>
                    <label class="block text-label text-[11px] uppercase tracking-wider mb-1.5 font-semibold">Avg Hours</label>
                    <input type="number" min="0" name="avg_hours" value="{{ old('avg_hours', 0) }}" required
                           class="w-full bg-white border border-line rounded-xl px-3.5 py-2.5 text-[13px] text-ink focus:border-navy focus:outline-none transition-colors">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" min="0" name="included_bedrooms" value="{{ old('included_bedrooms', 0) }}" required
                           class="w-full bg-white border border-line rounded-xl px-3.5 py-2.5 text-[13px] text-ink focus:border-navy focus:outline-none transition-colors">
                </div>
                <div>
                    <label class="block text-label text-[11px] uppercase tracking-wider mb-1.5 font-semibold">Included Bathrooms</label>
                    <input type="number" min="0" name="included_bathrooms" value="{{ old('included_bathrooms', 0) }}" required
                           class="w-full bg-white border border-line rounded-xl px-3.5 py-2.5 text-[13px] text-ink focus:border-navy focus:outline-none transition-colors">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="number" step="0.01" min="0" name="bedroom_price" value="{{ old('bedroom_price', 0) }}" required
                           class="w-full bg-white border border-line rounded-xl px-3.5 py-2.5 text-[13px] text-ink focus:border-navy focus:outline-none transition-colors">
                </div>
                <div>
                    <label class="block text-label text-[11px] uppercase tracking-wider mb-1.5 font-semibold">Extra Bathroom (R)</label>
                    <input type="number" step="0.01" min="0" name="bathroom_price" value="{{ old('bathroom_price', 0) }}" required
                           class="w-full bg-white border border-line rounded-xl px-3.5 py-2.5 text-[13px] text-ink focus:border-navy focus:outline-none transition-colors">
                </div>
                <div>
                    <label class="block text-label text-[11px] uppercase tracking-wider mb-1.5 font-semibold">Extra Room (R)</label>
                    <input type="number" step="0.01" min="0" name="extra_room_price" value="{{ old('extra_room_price', 0) }}" required
                           class="w-full bg-white border border-line rounded-xl px-3.5 py-2.5 text-[13px] text-ink focus:border-navy focus:outline-none transition-colors">
                </div>
            </div>
